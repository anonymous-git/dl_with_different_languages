...
python trans_models.py lenet1 rust
...
python trans_models.py lenet1 rust --sgd_lr_only
...
python trans_models.py lenet5 rust
...
python trans_models.py lenet5 rust --sgd_lr_only
...
python trans_models.py vgg16 rust
...
python trans_models.py vgg16 rust --sgd_lr_only
...
python trans_models.py resnet20 rust
...
python trans_models.py resnet20 rust --sgd_lr_only
...
python trans_models.py lstm rust
...
python trans_models.py gru rust
...
#python trans_models.py textcnn rust
